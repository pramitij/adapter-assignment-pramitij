...
import edu.neu.csye7374.AdapterPattern.Payment;
...
public class StockMarket {
    ...
    public void trade(StockAPI someStock, String metricType)
    {
        ...
        // Using Adapter Design Pattern below for payment functionality
        if(paymentIndicator==0) {
            payment.makePayment("cheque", someStock.getPrice());
            paymentIndicator=1;
        }
        else if(paymentIndicator==1) {
            payment.makePayment("googlepay", someStock.getPrice());
            paymentIndicator=2;
        }
        else {
            payment.makePayment("applepay", someStock.getPrice());
            paymentIndicator=0;
        }
